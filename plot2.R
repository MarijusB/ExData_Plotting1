...
#dev.copy(png,"plot2.png",width=10,height=8, units="in",res=100)
plot(DateTime, globalActivePower, type="l", main="Global Active Power", xlab="", ylab="Global Active Power (kW)")
dev.off()
